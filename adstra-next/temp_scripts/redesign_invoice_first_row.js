...
const oldHeaderStart = '{/* Simplified Boxed Layout */}';
const itemsTableMarker = '{/* Items Table */}';

const refinedBoxedLayout = `{/* Boxed GST Header - Logo and Details in First Row */}
                      ...
                      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <tbody>
                          <tr>
                            ...
                            <td style={{ padding: '2px 0' }}>: <span style={{ fontWeight: 'bold' }}>{invoice.invoice_no || "PROVISIONAL"}</span></td>
                          </tr>
                          <tr>
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log("Success: CreateInvoice.js updated with Logo and Details in First Row.");
} else {
  console.error("Error: Could not find placeholders.");
}
