...
PERMISSIONS = {
    ...
    "proforma_invoices.view": "View proforma invoices",
    ...
    "proforma_invoices.restore": "Restore proforma invoices",
    ...
    "receipts.restore": "Restore receipts",
...
def effective_permissions(user):
    ...
    if (
        ...
        and "lead.view_my_profile" in custom_permissions
        and "lead.view_all" not in custom_permissions
    ):
        custom_permissions = [code for code in custom_permissions if code != "lead.view_own"]
