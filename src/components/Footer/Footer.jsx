    ...
    <footer className="footer">
      <div className="footer__content">
        <div className="footer__logo-section">
          <h2 className="footer__logo">Adstra Digital</h2>
          <p className="footer__tagline">Innovating the future since 2025</p>
        </div>
        ...
        <div className="footer__socials" aria-label="Social Media Links">
          <a href="https://facebook.com/yourcompany" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="footer__social-link">
            {/* Facebook SVG */}
          ...
          <a href="https://twitter.com/yourcompany" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="footer__social-link">
            {/* Twitter SVG */}
            <svg width="24" height="24" fill="currentColor" aria-hidden="true" viewBox="0 0 24 24">
          ...
          <a href="https://linkedin.com/company/yourcompany" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="footer__social-link">
            {/* LinkedIn SVG */}
            <svg width="24" height="24" fill="currentColor" aria-hidden="true" viewBox="0 0 24 24">
